...
//  Copyright © 2019 Sri Apps. All rights reserved.
//
import AVFoundation
import UIKit
...
class ScannerViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func viewDidLoad() {
        ...
        if (captureSession.canAddOutput(metadataOutput)) {
            ...
            //add supported barcode types here
    ...
    //Present a message if the scan fails.
    func failed() {
    ...
    func found(code: String) {
        ...
        //Add more code here to execute when scanned

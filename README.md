...
- The naming convention to be followed is ```algo_name.language_extension``` i.e. the overall pathshould be ```language/algo_name.language_extension```
...
3. Make Pull Request to master of the original repo and enjoy.

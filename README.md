...
- The naming convention to be followed is ```algo_name.language_extension``` i.e. the overall path should be ```language/algo_name.language_extension```
- Example of above points: A heap sort written in Java should go into `java/heapsort.java`

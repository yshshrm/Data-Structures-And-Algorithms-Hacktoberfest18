...
public class BT_Siblings {

	static Scanner scn = new Scanner(System.in);

	public static void main(String[] args) {

		BT_Siblings bts = new BT_Siblings();
	...
	private class BinaryTree {
		...
		public void sibling() {
			this.sibling(null, this.root);
		}

		private void sibling(Node parent, Node node) {
			...
			sibling(node, node.left);
			sibling(node, node.right);
